                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-contact">
                            <h2>Contact Us</h2>
                            <a href="https://www.google.com/maps/search/daji+maharaj+takli/@19.1215822,77.0602008,17z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI0MTIwMS4xIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer"><p><i className="fa fa-map-marker-alt"></i>Daji Maharaj, Takli</p></a>
            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">THE DEVASTHAN</a> | 2024, All Right Reserved.</p>
                    </div>
                    <div className="col-md-6">
